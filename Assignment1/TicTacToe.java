   ...
   /**
     ...
     */
     public static void main(String[] args) {
        ...
        for (int i = 0; game.getLevel()<(lines*columns);i++){
          int playerChoice;
          boolean played = false;
          int play = game.getLevel();

          if (play%2 == 0){
            playerChoice = Integer.parseInt(console.readLine("X to play: ")) -1;
          }
          else{
            playerChoice = Integer.parseInt(console.readLine("O to play: ")) -1;
          }
